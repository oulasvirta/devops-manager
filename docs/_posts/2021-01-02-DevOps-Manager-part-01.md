...
![breakpoints](/devops-manager/assets/breakpoints-to-debug-authorize-and-callback.png)
...
![home page view](/devops-manager/assets/home-page-not-authorized.png)
...
![user is prompted to grant access](/devops-manager/assets/grant-access-prompt.png)
...
![authorization code](/devops-manager/assets/auth-response-code.png)
...
![home after user granted access](/devops-manager/assets/home-view-user-granted.png)
